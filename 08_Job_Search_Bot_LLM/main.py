...
#  Used to suppress any error messages (stderr) in Python
# os.devnull: This is a special file in Unix-like operating systems (and Windows) that acts as a "black hole" for output
sys.stderr = open(os.devnull, 'w') # This is the standard error stream, which typically outputs error messages and diagnostic information

# Custom class that differentiates from general exception ValueError
class ConfigError(Exception):
    pass

# Contains methods to validate the config and secrets coming from a yml file
class ConfigValidator:
    ...
    # Method definition (-> dict), annotation that specifies the return type of the function
...
def create_and_run_bot(email: str, password: str, parameters: dict, openai_api_key: str):
    try:
        ...
        # clear the terminal or command-line screen (nt -> windows)
